...
const Dashboard = () => {
  ...
  },
  {
    ...
    description: 'Based on your search history, we found a better alternative for Samsung Galaxy S24',
  ...
  const aiRecommendations = [
  {
    ...
    aiInsight: 'AI analysis shows 23% better low-light photography performance and ₹24,900 savings compared to similar flagship phones.'
  },
  {
    id: 2,
    ...
    aiInsight: 'Price dropped 15% this week. Historical data suggests this is the lowest price in 6 months.'
  }];
  ...
  const handleInsightCardClick = (card) => {
    switch (card?.title) {
      case 'Active Tracks':navigate('/watchlist-management');
        break;
      case 'Deal Success Rate':navigate('/price-history-analytics');
        break;
      case 'Price Alerts':navigate('/deal-alerts-and-notifications');
        break;
      default:
  ...
  const handleWatchlistItemAction = (action, item) => {
    switch (action) {
      case 'view':navigate('/product-comparison', { state: { productId: item?.id } });
        break;
      case 'remove':console.log('Remove item:', item?.id);
        break;
      case 'alert':navigate('/deal-alerts-and-notifications');
        break;
    }
  };
  ...
  const handleQuickAction = (action) => {
    switch (action) {
      case 'voice':navigate('/voice-and-camera-search');
        break;
      case 'camera':navigate('/voice-and-camera-search');
        break;
      case 'watchlist':navigate('/watchlist-management');
        break;
      case 'analytics':navigate('/price-history-analytics');
        break;
      case 'deals':navigate('/deal-alerts-and-notifications');
        break;
    }
  };
        ...
        <div className="text-center space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Discover the best deals with AI-powered search. Use voice, camera, or text to find products and get intelligent price insights.
            </p>
          </div>
