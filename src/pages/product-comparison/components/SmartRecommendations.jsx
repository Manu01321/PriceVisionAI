...
const SmartRecommendations = ({ currentProducts, onAddToComparison, onAddToWatchlist }) => {
  ...
  const mockRecommendations = {
    alternatives: [
    {
      ...
      imageAlt: 'Samsung Galaxy S24 Ultra smartphone in titanium gray color showing front and back design',
      currentPrice: 1199,
      originalPrice: 1299,
      rating: 4.6,
      reviewCount: 8420,
    ...
    bundles: [
    {
      ...
      imageAlt: 'iPhone 15 Pro bundle with AirPods Pro and MagSafe charger arranged on white surface',
      bundlePrice: 1299,
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between mb-2">
                ...
                <div className={`px-2 py-1 rounded text-xs font-medium ${getUrgencyColor(product?.dealUrgency)}`}>
  ...
  <div className="space-y-4">
    ...
    <div key={bundle?.id} className="bg-gradient-to-r from-success/5 to-primary/5 rounded-lg p-4 border border-border">
          <div className="flex items-start space-x-4">
            <div className="w-20 h-20 bg-surface rounded-lg overflow-hidden flex-shrink-0">
              <Image
            src={bundle?.image}
            ...
            <div className="flex-1">
              <div className="flex items-start justify-between mb-2">
                ...
                <div className={`px-2 py-1 rounded text-xs font-medium ${getUrgencyColor(bundle?.dealUrgency)}`}>
                  Limited Time
                </div>
              </div>
              ...
              <div className="space-y-2 mb-3">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="text-sm text-muted-foreground line-through">₹{bundle?.individualPrice}</div>
  ...
  <div className="space-y-4">
    ...
    <div key={trend?.id} className="bg-gradient-to-r from-warning/5 to-accent/5 rounded-lg p-4 border border-border">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <div className="flex items-start justify-between mb-2">
                ...
                <div className="text-right">
                  <div className="text-sm font-medium text-primary">{product?.similarityScore}% Similar</div>
                </div>
              </div>
