...
const AchievementsDisplay = ({ achievements, userStats }) => {
  ...
  { rank: 1, name: "Sarah Chen", avatar: "https://images.unsplash.com/photo-1597621969117-1a305d3e0c68", avatarAlt: "Professional headshot of Asian woman with shoulder-length black hair in white blazer", totalSavings: 2450, dealsFound: 89 },
  { rank: 2, name: "Mike Rodriguez", avatar: "https://images.unsplash.com/photo-1596717951382-a3cbbdd4b8fd", avatarAlt: "Professional headshot of Hispanic man with short dark hair in navy suit", totalSavings: 2180, dealsFound: 76 },
  { rank: 3, name: "You", avatar: userStats?.avatar, avatarAlt: userStats?.avatarAlt, totalSavings: 1850, dealsFound: 64, isCurrentUser: true },
  { rank: 4, name: "Emma Wilson", avatar: "https://images.unsplash.com/photo-1648466982925-65dac4ed0814", avatarAlt: "Professional headshot of Caucasian woman with blonde hair in business attire", totalSavings: 1720, dealsFound: 58 },
  { rank: 5, name: "David Kim", avatar: "https://images.unsplash.com/photo-1687256457585-3608dfa736c5", avatarAlt: "Professional headshot of Asian man with glasses in dark suit", totalSavings: 1650, dealsFound: 52 }];
                  ...
                  achievement?.earned ? getRarityBg(achievement?.rarity) : 'bg-muted'}`
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className={`px-2 py-1 text-xs rounded-full capitalize ${getRarityColor(achievement?.rarity)} ${getRarityBg(achievement?.rarity)}`}>
                          {achievement?.rarity}
                        </span>
                      </div>
            ...
            <div
              ...
              'border-primary bg-primary/5' : 'border-border hover:border-primary/50'}`
                ...
                user?.rank === 3 ? 'bg-accent/20 text-accent' : 'bg-muted text-muted-foreground'}`
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-2">
                      ...
                      {user?.isCurrentUser &&
                    <span className="px-2 py-1 bg-primary/10 text-primary text-xs rounded-full">You</span>
                    }
                    </div>
                ...
                <Icon
                  ...
                  user?.rank === 2 ? 'text-muted-foreground' : 'text-accent'
                  } />
